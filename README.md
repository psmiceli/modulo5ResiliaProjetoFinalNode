 ...
 **Em seguida configuramos ele para receber requisições com o corpo no formato JSON,<br> e requisições CORS para que o servidor responda a solicitações de qualquer domínio**<br>
